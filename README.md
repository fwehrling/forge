...
[![version](https://img.shields.io/badge/version-1.7.11-green)](https://github.com/fwehrling/forge/releases)
...
**Latest -- v1.7.11**: fix `echo -e` POSIX compatibility in install.sh and update.sh.
