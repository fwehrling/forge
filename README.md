...
[![version](https://img.shields.io/badge/version-1.7.18-green)](https://github.com/fwehrling/forge/releases)
...
**Latest -- v1.7.18**: update.sh self-update -- always runs the latest version from GitHub.
