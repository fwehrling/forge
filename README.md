...
[![version](https://img.shields.io/badge/version-1.7.17-green)](https://github.com/fwehrling/forge/releases)
...
**Latest -- v1.7.17**: fix `cp -r` creating nested skill directories on Linux.
