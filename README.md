...
**Critical fix** -- Auto-routing and Business Pack sections added to CLAUDE.md install template. Without these, `/forge` routing was silently broken for new installs.
