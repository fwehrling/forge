...
[![version](https://img.shields.io/badge/version-1.11.1-green)](https://github.com/fwehrling/forge/releases)
...
**Latest -- v1.11.1**: RTK anti-bypass -- strengthened CLAUDE.md instructions to prevent Claude from working around RTK token compression.
