...
[![version](https://img.shields.io/badge/version-1.7.2-green)](https://github.com/fwehrling/forge/releases)
...
**Latest -- v1.7.2**: Clean up deprecated skills on install/update (removes `forge-deploy` from existing installs).
