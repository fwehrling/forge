...
[![version](https://img.shields.io/badge/version-1.7.13-green)](https://github.com/fwehrling/forge/releases)
...
**Latest -- v1.7.13**: add `-y`/`--yes` flag to install.sh and update.sh for non-interactive mode.
