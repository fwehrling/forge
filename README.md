...
[![version](https://img.shields.io/badge/version-1.7.12-green)](https://github.com/fwehrling/forge/releases)
...
**Latest -- v1.7.12**: fix false positives in update.sh diff and find argument order warning.
