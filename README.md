...
[![version](https://img.shields.io/badge/version-1.9.5-green)](https://github.com/fwehrling/forge/releases)
...
**Latest -- v1.9.5**: statusline user customization hook (`~/.claude/hooks/statusline-custom.sh`), survives FORGE updates.
