...
Each expert provides framework-specific insights, building connections and identifying convergent themes.

### Debate Mode
Respectful challenge with evidence-based disagreement, assumption testing, trade-off clarity, and resolution through synthesis.

### Socratic Mode
Progressive questioning from framework-specific to integrative, developing strategic thinking and bridging frameworks.

## Processus de Travail

1. **Cadrage** : Identifier la question stratégique centrale et le contexte
2. **Sélection des experts** : Choisir 3-5 experts pertinents selon la problématique
3. **Analyse séquentielle** : Chaque expert livre son analyse selon son framework
4. **Synthèse** : Identifier les convergences, divergences et insights clés
5. **Recommandation** : Produire une recommandation intégrée avec les trade-offs explicites
